...
@section('contents')
    @if ($posts->count())
        ...
        <div class="grid grid-cols-1 mb-10 mx-24 mt-1 w-1/2 rounded overflow-hidden shadow-lg">

            <!--Card 1-->

            @if ($posts[0]->image)
                <center>
                    <div class="lg:h-400 md:72 sm:32 overflow-hidden pt-2">
                        <img src="{{ asset('/storage/' . $posts[0]->image) }}" class="w-full p-2">
                ...
                <div class="col-span-1 m-auto">
                    <div class="lg:grid lg:grid-cols-2 lg:gap-24 md:flex md:flex-row md:mx-auto px-1 sm:px-8 lg:gap-x-16">
                        <div class="col-span-1">
                            <a target="blank" href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=yudhatriya07@gmail.com"
                                class="flex items-center gap-2 font-montserrat text-white"><ion-icon class="text-xl"
                                    name="mail-outline"></ion-icon>yudhatriya07@gmail.com</a>
                        </div>
