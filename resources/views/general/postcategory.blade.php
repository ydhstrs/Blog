...
@section('contents')
    @if ($posts->count())
        <div class="grid grid-cols-1 mb-10 mx-24 mt-20 w-lg rounded overflow-hidden shadow-lg">

            <!--Card 1-->
            @if ($posts[0]->image)
                <div class="lg:h-600 md:72 sm:32 overflow-hidden">
                    <img src="{{ asset('/storage/' . $posts[0]->image) }}" class="w-full">
            ...
            <div class=" lg:border-gray-400 bg-white rounded-b m-6 flex flex-col justify-between leading-normal">
                <div class="mb-8">
                    <div class="text-gray-900 font-bold text-xl mb-2">{{ $posts[0]->title }}</div>
                    <p class="text-gray-700 text-base">{{ $posts[0]->excerpt }}</p>
                </div>
                <div class="text-sm">
                    <p class="text-gray-900 leading-none">Last Update</p>
                    <p class="text-gray-600">{{ $posts[0]->created_at->diffForHumans() }}</p>
                </div>
                <div class=" pt-4 pb-2">
                    <a href="/article/{{ $posts[0]->slug }}"
                        class="inline-block bg-orange-200 rounded-md px-3 py-1 text-sm font-semibold text-gray-900 mr-2 mb-2 hover:bg-orange-700">Read
                        More</a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-2 p-20">
            @foreach ($posts->skip(1) as $news)
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                    ...
                    <p class="text-gray-600 text-sm">{{ $news->created_at->diffForHumans() }}</p>
                ...
                <div class="col-span-1 m-auto">
                    ...
                    <div class="container">
                        ...
                        <div class="flex items-center">
                            <a href="https://www.youtube.com/MyWild28" target="_blank"
                 ...
                 border-white text-white hover:bg-slate-800  hover:text-slate-400">
                            ...
                            <a href="https://www.tiktok.com/@xplays.ids" target="_blank"
                                class="w-10 h-10 mr-3 rounded-full flex justify-center items-center border
                 border-white text-white hover:bg-slate-800  hover:text-slate-400">
                                <svg role="img" width="23" class="fill-current" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.linkedin.com/in/yudha-triya-69241714b/" target="_blank"
                                class="w-10 h-10 mr-3 rounded-full flex justify-center items-center border
                 border-white text-white hover:bg-slate-800  hover:text-slate-400">
                                <svg role="img" width="23" class="fill-current" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.instagram.com/ydhstrs/" target="_blank"
                                class="w-10 h-10 mr-3 rounded-full flex justify-center items-center border
                 border-white text-white hover:bg-slate-800  hover:text-slate-400">
                            ...
                            <a href="https://github.com/ydhstrs" target="_blank"
                                class="w-10 h-10 mr-3 rounded-full flex justify-center items-center border
                 border-white text-white hover:bg-slate-800  hover:text-slate-400">
                ...
                <div class="col-span-1 m-auto">
                    <div class="lg:grid lg:grid-cols-2 lg:gap-24 md:flex md:flex-row md:mx-auto px-1 sm:px-8 lg:gap-x-16">
                        <div class="col-span-1">
                            ...
                            <iframe src="https://www.youtube.com/embed?listType=playlist&list=UUYT-bpvylZTjXgFBw26F7PQ">
                            </iframe>
            ...
            if(response.data && response.data.items) {
                ...
                if(items.length>0) {
                    ...
                    $('#static_video').html(video);
                            ...
                            {{-- <script type="text/javascript" src="https://gdata.youtube.com/feeds/api/users/xplay-w3/uploads?max-results=1&orderby=published&v=2&alt=jsonc&callback=showVideo"></script> --}}
